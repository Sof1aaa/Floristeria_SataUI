...
{
    public partial class Regis_cliente : Form
    {
        ...
        public void cargar_imagen(object sender, EventArgs e)
        {
            try
            {
                ...
                string imagesFolderPath = Path.Combine(Application.StartupPath, "Clientes");
        ...
        private void sataButton1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txt_tel.Texts))
            {
                MessageBox.Show("Por favor, ingrese el documento de usuario.");
                return;
            }
            ...
            try
            {
                ...
                controllers_query.query_cliente query = new controllers_query.query_cliente();

                query.insertar_cliente(doc.ToString(), txt_name.Texts,txt_last.Texts, tel.ToString(),txt_email.Texts,txt_dir.Texts, imgPath);
